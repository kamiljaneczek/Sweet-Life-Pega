    ...
    if (isPegaReady) {
      getSdkConfig().then(sdkConfig => {
        ...
        if (!mashupCaseType) {
          ...
          mashupCaseType = caseTypes[2].pyWorkTypeImplementationClassName;
        }
          ...
          <section className=''>
            <div className='py-8 lg:py-16 px-4 mx-auto max-w-screen-md'>
              ...
              <form action='#' className='space-y-8'>
                <div>
                  <Input type='email' id='email' label='Your email' helperText='' placeholder='name@pega.com' InputProps='' error={false} required />
                </div>
                <div>
                  <Input
                    type='text'
