          ...
          <div className='grid mb-8 lg:mb-12 lg:grid-cols-2 gap-8'>
            <figure className='flex flex-col justify-center items-center p-8 rounded-lg text-center bg-gray-50 border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700'>
              <blockquote className='mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400'>
                ...
                <p className='my-4 text-lg'>
                  "I've never tasted sweets quite like those from Sweet Life. From the moment you take your first bite, you're transported to a world
                  of pure bliss. Each confection is meticulously crafted with the finest ingredients, and the attention to detail is evident in every
                  mouthful
                </p>
                <p className='my-4  text-lg'>
            ...
            <figure className='flex flex-col justify-center items-center p-8 rounded-lg  text-center bg-gray-50 border-b border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700'>
              <blockquote className='mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400'>
                ...
                <p className='my-4 text-lg'>
                  "Sweet Life's sweets are a true indulgence. From the first glance at their beautifully decorated pastries to the last bite of their
                  heavenly chocolates, every experience with Sweet Life is unforgettable. Their treats have become my go-to for every special
                  occasion, from birthdays to anniversaries and everything in between. What sets Sweet Life apart is not only the exceptional taste of
                  their sweets but also the passion and dedication that goes into each creation.
                </p>
                <p className='my-4 text-lg'>
                  It's evident that every dessert is made with love, and that's what makes Sweet Life truly special. Thank you for making every moment
                  sweeter!"
                </p>
              </blockquote>
              <figcaption className='flex justify-center items-center space-x-3'>
            ...
            <figure className='flex flex-col justify-center items-center p-8 rounded-lg  text-center bg-gray-50 border-b border-gray-200 lg:border-b-0 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700'>
              <blockquote className='mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400'>
                ...
                <p className='my-4 text-lg'>
                  "Absolutely delightful! From the moment you step into Sweet Life's shop, you're greeted with the irresistible aroma of freshly baked
                  goodies.
                </p>
                <p className='my-4 text-lg'>
                  The flavors are so rich and decadent, it's like a party in your mouth with every bite. Each sweet is expertly crafted with care and
                  precision, ensuring that every aspect of the dessert is perfection. Whether you're a chocolate lover or a fan of fruity delights,
                  there's something for everyone at Sweet Life. Their treats have become a staple in my life, and I can't imagine celebrating any
                  special occasion without them! 🤯..
                </p>
                <p className='my-4 text-lg'>
            ...
            <figure className='flex flex-col justify-center items-center p-8 rounded-lg  text-center bg-gray-50 border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700'>
              <blockquote className='mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400'>
                ...
                <p className='my-4 text-lg'>
                  ...
                  Every dessert feels like a work of art, meticulously crafted to perfection. Whether it's their delicate macarons or their indulgent
                  cheesecakes, each sweet is a testament to Sweet Life's dedication to excellence.
                </p>
                <p className='my-4 text-lg'>
                  I find myself constantly craving their treats, and I'm always excited to see what new creations they come up with. Thank you, Sweet
                  Life, for continually delighting my taste buds and bringing sweetness into my life!"
                </p>
              </blockquote>
              <figcaption className='flex justify-center items-center space-x-3'>
                <img
