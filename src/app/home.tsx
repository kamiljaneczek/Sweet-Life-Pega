            ...
            <div className='container px-4 md:px-6'>
              ...
              <div className='grid gap-10 sm:px-10 md:gap-16 md:grid-cols-3 pt-6'>
                <div className='space-y-4'>
                  ...
                  <h2 className='mb-4 text-2xl font-semibold tracking-tight leading-none text-gray-900 dark:text-white'>
                ...
                <div className='space-y-4'>
                  ...
                  <p className='text-gray-500 dark:text-gray-400 text-lg'>
                    Our ice creams are made with the freshest ingredients and churned to perfection. Indulge in a variety of classic and unique
                    flavors.
                  </p>
                  <Button variant='outline' size='sm'>
                    Read more
              ...
              <div className='grid mb-8 lg:mb-12 lg:grid-cols-2 gap-8'>
                ...
                <figure className='flex flex-col justify-center items-center p-8 rounded-lg  text-center bg-gray-50 border-b border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700'>
                  <blockquote className='mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400'>
                    ...
                    <p className='my-4 text-lg'>
                      ...
                      their heavenly chocolates, every experience with Sweet Life is unforgettable. Their treats have become my go-to for every
                      special occasion, from birthdays to anniversaries and everything in between. What sets Sweet Life apart is not only the
                      exceptional taste of their sweets but also the passion and dedication that goes into each creation.
                    </p>
                    <p className='my-4 text-lg'>
                ...
                <figure className='flex flex-col justify-center items-center p-8 rounded-lg  text-center bg-gray-50 border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700'>
                  <blockquote className='mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400'>
                    ...
                    <p className='my-4 text-lg'>
                      "As a self-proclaimed dessert aficionado, I've had my fair share of sweets from all around the world. But none have quite
                      captured my heart like those from Sweet Life. From the moment I discovered their shop, I knew I had stumbled upon something
                      extraordinary. Every dessert feels like a work of art, meticulously crafted to perfection. Whether it's their delicate macarons
                      or their indulgent cheesecakes, each sweet is a testament to Sweet Life's dedication to excellence.
                    </p>
                    <p className='my-4 text-lg'>
