...
export type GetCaseTypeInfoFlatListOfFields = (typeof GetCaseTypeInfoFlatListOfFields)[keyof typeof GetCaseTypeInfoFlatListOfFields];

export const GetCaseTypeInfoFlatListOfFields = {
  Full: 'Full',
  Basic: 'Basic'
} as const;
