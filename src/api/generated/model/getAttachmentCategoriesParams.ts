 ...
 */
import type { GetAttachmentCategoriesType } from './getAttachmentCategoriesType';

export type GetAttachmentCategoriesParams = {
  /**
   * Type of attachment category
   */
  type?: GetAttachmentCategoriesType;
};
