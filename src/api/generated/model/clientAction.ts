 ...
 */
import type { ActionProcess } from './actionProcess';
import type { ClientActionAction } from './clientActionAction';

export interface ClientAction {
  action?: ClientActionAction;
  /** either name of control or unique ID */
  refreshFor?: string;
