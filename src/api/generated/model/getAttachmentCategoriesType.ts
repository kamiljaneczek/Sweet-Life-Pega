...
export type GetAttachmentCategoriesType = (typeof GetAttachmentCategoriesType)[keyof typeof GetAttachmentCategoriesType];

export const GetAttachmentCategoriesType = {
  File: 'File',
  URL: 'URL'
} as const;
