...
export type GetCaseActionInfoFlatListOfFields = (typeof GetCaseActionInfoFlatListOfFields)[keyof typeof GetCaseActionInfoFlatListOfFields];

export const GetCaseActionInfoFlatListOfFields = {
  Full: 'Full',
  Basic: 'Basic'
} as const;
