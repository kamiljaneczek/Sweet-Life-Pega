...
export type GetAssignmentActionInfoFlatListOfFields =
  (typeof GetAssignmentActionInfoFlatListOfFields)[keyof typeof GetAssignmentActionInfoFlatListOfFields];

export const GetAssignmentActionInfoFlatListOfFields = {
  Full: 'Full',
  Basic: 'Basic'
} as const;
